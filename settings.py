...
LANGUAGE_CODE = 'es-pe'# Opciones para el envio de emails desde el servidor
...
SECRET_KEY = ')qlx_^isw#@#sfhnjbbb2bn7_%%e1m@34@gd%m*a03b0ai!$3_'
...
# Opciones del cache
# TODO: Cambiar los valores para el caché
